...
export default function PhotoModalEditor({ visible, specEdit, searchId, photos, delPhoto, onClose, onSave }) {
    ...
    const productsArr = useSelector(state => state.products.items);
