...
import { addCommunityAddPhoto } from "../../redux/actions/communityAddInfoActions";
...
export default function CameraScreen() {
    ...
    const handleDone = () => {
        ...
        photosToAdd.forEach((photo) => dispatch(addCommunityAddPhoto(photo)));
        setPhotos([]);
        navigation.navigate("CommunityAddInfo");
    };
